...
class ControllerExtensionPaymentGlobalPayments extends Controller {
	...
	public function index() {
		...
		$data['action'] = $this->url->link('extension/payment/globalpayments', 'token=' . $this->session->data['token'], true);
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/payment/globalpayments', 'token=' . $this->session->data['token'], true)
		);
